...
# 1. Configuration
csv_filename = SIR_TOSCANA_PATH+"idrometri_stations_firenze.csv"
output_folder = SIR_TOSCANA_PATH+"sir_idrometry_toscana_datasets"
idrometry_base_url = "https://www.sir.toscana.it/archivio/download.php?IDST=idro_l&IDS="
...
try:
    with open(csv_filename, mode='r', encoding='utf-8-sig') as f:
        ...
        for index, row in enumerate(stations, 1):
            ...
            download_url = f"{idrometry_base_url}{code}"
