...
# 1. Configuration
csv_filename = SIR_TOSCANA_PATH+"termometri_stations_firenze.csv"
output_folder = SIR_TOSCANA_PATH+"sir_temperature_toscana_datasets"
temperature_base_url = "https://www.sir.toscana.it/archivio/download.php?IDST=termo_csv&IDS="
...
try:
    with open(csv_filename, mode='r', encoding='utf-8-sig') as f:
        ...
        for index, row in enumerate(stations, 1):
            ...
            download_url = f"{temperature_base_url}{code}"
